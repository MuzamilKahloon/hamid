  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center min-h-screen">
        <Navbar />
        <div className="w-full max-w-sm p-6 border border-white rounded-md shadow-md">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="relative mb-4">
              ...
              <button
                type="button"
                className="absolute transform -translate-y-1/2 right-3 top-11 focus:outline-none"
